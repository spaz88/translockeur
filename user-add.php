                ...
                <form action="user-verif.php?action=user-add" method="post" class="form-horizontal" encytype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label class="col-md-4 controle-label" for="nom">Nom<span style='color:red;'>*</span></label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 controle-label" for="prenom">Prenom<span style='color:red;'>*</span></label></label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 controle-label" for="pseudo">Pseudo<span style='color:red;'>*</span></label></label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 controle-label" for="password">Mot de passe<span style='color:red;'>*</span></label></label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 controle-label" for="avatar">Avatar<span style='color:red;'>*</span></label></label>
                            <div class="col-md-4">
